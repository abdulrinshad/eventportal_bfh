...
import { FiUser, FiMail, FiCalendar, FiEdit2, FiSave, FiX, FiMapPin, FiAward } from 'react-icons/fi';
...
export default function OrganizerProfile() {
  ...
  const [form, setForm] = useState({
    username: user?.username || 'Bob Organizer',
  ...
  return (
    <OrganizerLayout activeItem="Profile">
      <PageContainer size="xl">
        <PageHeader
          title="Profile"
          description="Manage your professional presence and event planner portfolio."
          action={
            !editing ? (
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
                <div>
                  ...
                  <p style={{ fontSize: '15px', color: '#475569', margin: '0 0 8px 0', fontWeight: '500' }}>
                    Senior Event Planner &amp; Coordinator
                  </p>
                ...
                <div style={{ display: 'flex', gap: '20px' }}>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '18px', fontWeight: '800', color: '#111827' }}>16</div>
                    <div style={{ fontSize: '11px', color: '#94A3B8', fontWeight: '600' }}>EVENTS HOSTED</div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '18px', fontWeight: '800', color: '#111827' }}>1,248</div>
            ...
            <ContentCard>
              ...
              {editing ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '13px', fontWeight: '600', color: '#374151', marginBottom: '6px' }}>Organizer Biography</label>
                    <textarea
                      name="bio"
                      rows={5}
                      value={form.bio}
