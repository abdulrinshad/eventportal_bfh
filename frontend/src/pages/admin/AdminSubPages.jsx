...
/* ────────────────────────────────────────────────────────
   DUMMY DATA & STATE GENERATORS FOR INTERACTION
   ──────────────────────────────────────────────────────── */

const INITIAL_USERS = [
  { id: 1, name: 'Julius Caesar', email: 'julius@rome.gov', role: 'Organizer', status: 'Active', joined: '2026-01-10', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80' },
  { id: 2, name: 'Cleopatra VII', email: 'cleo@alexandria.net', role: 'Organizer', status: 'Active', joined: '2026-02-14', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80' },
  { id: 3, name: 'Marcus Aurelius', email: 'marcus@philosophy.edu', role: 'Attendee', status: 'Active', joined: '2026-03-01', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80' },
  { id: 4, name: 'Marie Curie', email: 'marie@science.fr', role: 'Organizer', status: 'Pending', joined: '2026-07-20', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80' },
  { id: 5, name: 'Albert Einstein', email: 'albert@relativity.org', role: 'Attendee', status: 'Suspended', joined: '2026-04-12', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80' },
];

const INITIAL_EVENTS = [
  { id: 1, title: 'Global Tech Summit 2026', organizer: 'Julius Caesar', category: 'Technology', location: 'San Francisco, CA', participants: 420, capacity: 500, status: 'Active', date: '2026-10-12', revenue: 42890, featured: true, thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=120&q=80' },
  { id: 2, title: 'AI & Machine Learning Expo', organizer: 'Cleopatra VII', category: 'Technology', location: 'Austin, TX', participants: 310, capacity: 350, status: 'Active', date: '2026-11-05', revenue: 31000, featured: false, thumbnail: 'https://images.unsplash.com/photo-1591453089816-0fbb971b454c?auto=format&fit=crop&w=120&q=80' },
  { id: 3, title: 'Quantum Computing Intro', organizer: 'Marie Curie', category: 'Education', location: 'Virtual', participants: 0, capacity: 100, status: 'Pending', date: '2026-08-20', revenue: 0, featured: false, thumbnail: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=120&q=80' },
  { id: 4, title: 'Design Patterns Deep Dive', organizer: 'Julius Caesar', category: 'Design', location: 'New York, NY', participants: 98, capacity: 100, status: 'Completed', date: '2026-06-15', revenue: 9800, featured: false, thumbnail: 'https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=120&q=80' },
  { id: 5, title: 'Future Visionary Summit 2026', organizer: 'Cleopatra VII', category: 'Business', location: 'San Francisco, CA', participants: 180, capacity: 200, status: 'Cancelled', date: '2026-12-01', revenue: 0, featured: false, thumbnail: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?auto=format&fit=crop&w=120&q=80' }
];

const INITIAL_REGISTRATIONS = [
  { id: 'REG-901', event: 'Global Tech Summit 2026', name: 'Marcus Aurelius', ticket: 'VIP Access', paid: '$150', status: 'Success', qr: 'Scanned', refund: 'None' },
  { id: 'REG-902', event: 'AI & Machine Learning Expo', name: 'Albert Einstein', ticket: 'General Pass', paid: '$100', status: 'Success', qr: 'Pending', refund: 'None' },
  { id: 'REG-903', event: 'Design Patterns Deep Dive', name: 'Marie Curie', ticket: 'Workshop Entry', paid: '$120', status: 'Refunded', qr: 'Unused', refund: 'Completed' },
  { id: 'REG-904', event: 'Global Tech Summit 2026', name: 'Cleopatra VII', ticket: 'VIP Access', paid: '$150', status: 'Success', qr: 'Scanned', refund: 'None' },
  { id: 'REG-905', event: 'AI & Machine Learning Expo', name: 'Julius Caesar', ticket: 'General Pass', paid: '$100', status: 'Failed', qr: 'Unused', refund: 'None' },
];

const INITIAL_TRANSACTIONS = [
  { id: 'TXN-90112', name: 'Marcus Aurelius', email: 'marcus@philosophy.edu', amount: 150.00, status: 'Completed', type: 'Purchase', date: '2026-07-24 15:30' },
  { id: 'TXN-90113', name: 'Albert Einstein', email: 'albert@relativity.org', amount: 100.00, status: 'Completed', type: 'Purchase', date: '2026-07-24 14:15' },
  { id: 'TXN-90114', name: 'Marie Curie', email: 'marie@science.fr', amount: 120.00, status: 'Refunded', type: 'Refund', date: '2026-07-23 11:00' },
  { id: 'TXN-90115', name: 'Richard Feynman', email: 'richard@physics.edu', amount: 150.00, status: 'Failed', type: 'Purchase', date: '2026-07-23 09:30' },
];
...
export function OverviewTab({ setActiveTab, setGlobalToast }) {
  const kpis = [
    { title: 'Total Users', value: '4,890', trend: '+14.2%', isUp: true, points: [10, 12, 15, 14, 18, 22, 28], icon: Users, color: '#6366F1' },
    { title: 'Total Events', value: '254', trend: '+8.1%', isUp: true, points: [5, 6, 8, 7, 10, 12, 15], icon: Calendar, color: '#3B82F6' },
    { title: 'Active Events', value: '18', trend: '+12.5%', isUp: true, points: [12, 14, 13, 15, 17, 16, 18], icon: TrendingUp, color: '#10B981' },
    { title: 'Completed Events', value: '198', trend: '+20.1%', isUp: true, points: [30, 45, 60, 85, 110, 150, 198], icon: CheckCircle, color: '#8B5CF6' },
    { title: 'Upcoming Events', value: '38', trend: '-2.4%', isUp: false, points: [45, 42, 44, 40, 39, 41, 38], icon: Calendar, color: '#EC4899' },
    { title: 'Total Revenue', value: '$84,290', trend: '+18.4%', isUp: true, points: [20, 25, 32, 45, 58, 70, 84], icon: DollarSign, color: '#F5C451' },
    { title: 'Registrations', value: '1,248', trend: '+11.8%', isUp: true, points: [80, 95, 110, 105, 118, 125, 124], icon: Ticket, color: '#14B8A6' },
    { title: 'Pending Approvals', value: '3', trend: '-25.0%', isUp: false, points: [8, 6, 5, 5, 4, 3, 3], icon: ShieldAlert, color: '#EF4444' },
    { title: 'Cancelled Events', value: '8', trend: '0.0%', isUp: true, points: [4, 5, 5, 6, 8, 8, 8], icon: XCircle, color: '#6B7280' }
  ];
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '600px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <button
              onClick={() => {
                setGlobalToast('Generated fresh Excel summary system-wide.');
              }}
...
export function AnalyticsTab() {
  ...
  // SVG Chart Generators for professional UI looks
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <h2 style={{ fontSize: '22px', fontWeight: '800', margin: 0 }}>Analytics Overview</h2>
          <p style={{ fontSize: '14px', color: 'var(--text-secondary)', margin: '4px 0 0 0' }}>Real-time telemetry and financial analysis</p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '24px' }} className="analytics-grid">
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ height: '300px', position: 'relative', width: '100%', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', padding: '10px 0' }}>
            {/* Custom Interactive SVG Graph mockup */}
            <svg width="100%" height="100%" viewBox="0 0 500 220" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0, overflow: 'visible' }}>
              ...
              {/* Area path */}
              <path
                d="M 0 180 L 80 150 L 160 160 L 240 100 L 320 110 L 400 40 L 500 20 L 500 220 L 0 220 Z"
                fill="url(#chartGrad)"
              />
              {/* Stroke path */}
              <path
                d="M 0 180 L 80 150 L 160 160 L 240 100 L 320 110 L 400 40 L 500 20"
                fill="none"
                stroke="#F5C451"
                strokeWidth="4"
                strokeLinecap="round"
              ...
              />
              {/* Dots */}
              <circle cx="80" cy="150" r="5" fill="#111827" stroke="#F5C451" strokeWidth="2" />
              <circle cx="240" cy="100" r="5" fill="#111827" stroke="#F5C451" strokeWidth="2" />
              <circle cx="400" cy="40" r="5" fill="#111827" stroke="#F5C451" strokeWidth="2" />
              <circle cx="500" cy="20" r="5" fill="#111827" stroke="#F5C451" strokeWidth="2" />
            </svg>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            {[
              { name: 'Technology', value: 48, color: '#6366F1' },
              { name: 'Business', value: 24, color: '#3B82F6' },
              { name: 'Education', value: 16, color: '#10B981' },
              { name: 'Design & Arts', value: 12, color: '#EC4899' },
            ].map((cat, idx) => (
              <div key={idx}>
                ...
                <div style={{ width: '100%', height: '8px', background: 'var(--border-color-light)', borderRadius: '999px', overflow: 'hidden' }}>
                  <div style={{ width: `${cat.value}%`, height: '100%', background: cat.color, borderRadius: '999px' }} />
                </div>
              </div>
            ))}
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }} className="analytics-grid">
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Interactive 24-day platform usage density matrix</span>
        </div>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            ...
            <div>
              <div style={{ fontSize: '24px', fontWeight: '800' }}>82.4%</div>
              <p style={{ fontSize: '12px', color: 'var(--text-secondary)', margin: '4px 0 0 0' }}>Average ticket redemption rate across all tech hubs.</p>
            </div>
          </div>
        </div>
      </div>
...
export function UsersTab({ setGlobalToast }) {
  ...
  const toggleUserStatus = (id) => {
    setUsers(prev => prev.map(u => {
      if (u.id === id) {
        ...
        setGlobalToast(`User ${u.name} is now ${newStatus}`);
  ...
  const deleteUser = (id) => {
    ...
    if (userToDelete) {
      setGlobalToast(`Deleted user account: ${userToDelete.name}`);
    }
  };
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <button
          onClick={() => {
            ...
            dl.click();
            setGlobalToast('Successfully downloaded user base metadata.');
          }}
            ...
            {filtered.map(user => (
              <tr key={user.id} style={{ borderBottom: '1px solid var(--border-color-light)' }}>
                <td style={{ padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <img src={user.avatar} alt="avatar" style={{ width: '38px', height: '38px', borderRadius: '50%', objectFit: 'cover' }} />
                  <div>
                ...
                <td style={{ padding: '16px 20px' }}>
                  <span
                    style={{
                      ...
                      color: user.status === 'Active' ? '#15803D' : user.status === 'Pending' ? '#B45309' : '#EF4444'
                    }}
                  >
                    {user.status}
                  </span>
...
export function ApprovalsTab({ setGlobalToast }) {
  const [approvals, setApprovals] = useState([
    { id: 1, title: 'Decentralized Finance Workshop 2026', organizer: 'Satoshi Nakamoto', category: 'Finance', capacity: 200, proposedDate: '2026-09-10', price: '$200', notes: 'Requesting permission to run parallel VIP breakout session.' },
    { id: 2, title: 'NextJS Server Components Mastery', organizer: 'Grace Hopper', category: 'Technology', capacity: 500, proposedDate: '2026-10-01', price: 'Free', notes: 'Sponsoring attendee lunch boxes. Need to verify logo placement.' }
  ]);
  ...
  const handleAction = (id, action) => {
    ...
    setGlobalToast(`Event application has been successfully ${action}.`);
  };
...
export function RegistrationsTab({ setGlobalToast }) {
  ...
  const filtered = registrations.filter(r => r.name.toLowerCase().includes(search.toLowerCase()) || r.event.toLowerCase().includes(search.toLowerCase()));
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ fontSize: '28px', fontWeight: '800', margin: '8px 0', color: '#10B981' }}>$34,120.00</div>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ fontSize: '28px', fontWeight: '800', margin: '8px 0' }}>$84,290.00</div>
          <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Across 13 partner links</span>
        </div>
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
          <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: '700', textTransform: 'uppercase' }}>Failed Transactions</span>
          <div style={{ fontSize: '28px', fontWeight: '800', margin: '8px 0', color: '#EF4444' }}>$1,250.00</div>
          <span style={{ fontSize: '11px', color: '#EF4444' }}>Click to retry payouts</span>
        </div>
      </div>
...
export function CategoriesTab({ setGlobalToast }) {
  const [categories, setCategories] = useState([
    { id: 1, name: 'Technology', count: 124, description: 'Software, web apps, hacking conferences.' },
    { id: 2, name: 'Education', count: 48, description: 'Academic classes, math webinars, writing sessions.' },
    { id: 3, name: 'Design', count: 32, description: 'UX layout reviews, vector illustrations.' },
    { id: 4, name: 'Business', count: 50, description: 'Founder networking, venture capital meetups.' },
  ]);
...
export function ReportsTab({ setGlobalToast }) {
  ...
  const downloadReport = (format) => {
    setGlobalToast(`Generated ${reportType.toUpperCase()} document report in ${format.toUpperCase()} format.`);
  };
...
export function NotificationsTab({ setGlobalToast }) {
  ...
  const sendNotification = (e) => {
    e.preventDefault();
    setGlobalToast(`Broadcasted notification on channel: ${channel.toUpperCase()} matching: ${template.toUpperCase()}`);
    setCustomMsg('');
  };
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '28px' }} className="analytics-grid">
      ...
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color-light)', borderRadius: '20px', padding: '24px', boxShadow: 'var(--shadow-sm)' }}>
        <h3 style={{ fontSize: '16px', fontWeight: '700', marginBottom: '20px' }}>Compose Broadcast Campaign</h3>
        <form onSubmit={sendNotification} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button type="submit" style={{ padding: '12px', background: '#F5C451', color: '#111827', border: 'none', borderRadius: '10px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
            Broadcast Dispatch <Send size={16} />
          </button>
        </form>
      </div>
    </div>
...
export function AuditLogsTab() {
  const auditData = [
    { id: 1, action: 'ADMIN_LOGIN_SUCCESS', desc: 'Administrator session opened successfully from IP 192.168.1.100', admin: 'Alex Morgan', time: '2026-07-24 22:30:15' },
    { id: 2, action: 'EVENT_VERIFIED', desc: 'Approved listing "NextJS Server Components Mastery"', admin: 'Alex Morgan', time: '2026-07-24 22:04:12' },
    { id: 3, action: 'USER_SUSPENDED', desc: 'Suspended user ID #5 (Albert Einstein) due to policy violation', admin: 'Alex Morgan', time: '2026-07-24 21:55:00' },
    { id: 4, action: 'REPORT_EXPORTS', desc: 'Exported spreadsheet database list to Excel file format', admin: 'Alex Morgan', time: '2026-07-24 20:30:44' },
    { id: 5, action: 'GATEWAY_CREDENTIALS_REVISED', desc: 'Regenerated Sandbox Stripe API keys in enterprise settings', admin: 'System Operator', time: '2026-07-23 18:12:00' }
  ];
